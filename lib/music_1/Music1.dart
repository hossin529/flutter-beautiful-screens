      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
                    ...
                    Center(
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: ClipOval(
                            clipper: MClipper(),
                            child: Image.asset('assets/hossin.jpg',fit: BoxFit.cover,)),
                        ),
                      ),
                    )
                  ],
            ...
            Column(
              children: <Widget>[
                Text('Houssaine El Ghazely',style:TextStyle(
                    color: Color(0xFFFE1483),
                    fontSize: 24,
              ...
              child: Stack(children: <Widget>[
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      onPressed: (){},
                      icon: Icon(Icons.play_arrow,color:Colors.white,size:59),
                    ),
                  ),
                )
              ],),
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Center(child: Column(
                    ...
                    children: <Widget>[
                      Text('Houssaine BackEnd',style:TextStyle(
                    color: Color(0xFFFE1483),
                    fontSize: 14,
                    fontWeight: FontWeight.bold
                )),
                      Text('Houssaine API',style:TextStyle(
                    color: Color(0xFFFE1483),
                    fontSize: 14,
                    fontWeight: FontWeight.bold
                )),
                      Text('Houssaine FrontEnd',style:TextStyle(
                    color: Color(0xFFFE1483),
                    fontSize: 14,
                    fontWeight: FontWeight.bold
                )),
